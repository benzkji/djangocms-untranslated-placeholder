...
- [djangocms_untranslated_placeholder.basic](#basic) (various tools and helpers)
- [djangocms_untranslated_placeholder.admin_style](#admin-style) (enhancements for djangocms-admin-style)
- [djangocms_untranslated_placeholder.alternate_toolbar](#alternate-toolbar) (alternate djangocms toolbar)
- [djangocms_untranslated_placeholder.global_untranslated_placeholder](#global-untranslated-placeholder) (as it says)
- [djangocms_untranslated_placeholder.autopublisher](#autopublisher) (draft and live always in sync)
- djangocms_untranslated_placeholder.editmode_fallback_placeholder / djangocms_untranslated_placeholder.untranslated_placeholder
...
- djangocms_untranslated_placeholder.apphook_templates
...
To get the latest stable release from PyPi
    ...
    pip install djangocms-untranslated-placeholder

Add needed ``djangocms-untranslated-placeholder`` subapps to your ``INSTALLED_APPS``

    INSTALLED_APPS = (
        ...,
        'djangocms_untranslated_placeholder.basic',  # tags, cms frontend enhances
        'djangocms_untranslated_placeholder.admin_style',  # djangocms-admin-style enhanced
        'djangocms_untranslated_placeholder.apphook_templates',  # experimental, not implemented
    )
...
**Pagelink tag**, looks for page, displays nothing if nothing found.
    ...
    {% load djangocms_untranslated_placeholder_tags %}
    {% djangocms_untranslated_placeholder_page_link 'contact' %}
...
the following stylesheet in your main html template.
    ...
    <link rel="stylesheet" href="{{ STATIC_URL }}djangocms_untranslated_placeholder/css/cms_frontend_adjust.css">

**get_env contect processor**, add SITE_ID and if available, is_live/stage/dev/whatever to the context.

Add

    'djangocms_untranslated_placeholder.basic.context_processors.get_env'
...
Add
    ...
    'djangocms_untranslated_placeholder.basic.middleware.RedirectFirstSubpageMiddleware'

to your `settings.MIDDLEWARE`. A small change to the `menu/menu.html` template is needed, check 
https://github.com/bnzk/djangocms-untranslated-placeholder/tree/develop/djangocms_untranslated_placeholder/basic/templates/menu/menu.html
(in fact, only check if the redirect is actually `/firstchild`). To make this work, `djangocms_untranslated_placeholder.basic` must be 
...
Add
    ...
    'djangocms_untranslated_placeholder.basic.middleware.PasswordProtectedMiddleware'
...
Add
    ...
    'djangocms_untranslated_placeholder.basic.middleware.Bot404Middleware'
...
Add `djangocms_untranslated_placeholder.admin_style` to `INSTALLED_APPS`, before `djangocms_admin_style`, to have a slightly optimized/opiniated djangocms-admin-style
...
Add `djangocms_untranslated_placeholder.alternate_toolbar` to `INSTALLED_APPS`, and you'll have it as is.
If you want custom items in your administration menu, create your own `cms_toolbars.py`, as follows:
    ...
    from djangocms_untranslated_placeholder.alternate_toolbar.cms_toolbars import AlternateBasicToolbar
...
usage: add `djangocms_untranslated_placeholder.gloabl_untranslated_placeholder` to `INSTALLED_APPS`. In your settings,
...
usage: add `djangocms_untranslated_placeholder.autopublisher` to `INSTALLED_APPS`. Due to when exactly some singals are
...
approaches, that can be tried: `djangocms_untranslated_placeholder.editmode_fallback_placeholder` (always displaying
fallbacks) or `djangocms_untranslated_placeholder.untranslated_placeholder` (kind a "real" untranslated placeholder).
